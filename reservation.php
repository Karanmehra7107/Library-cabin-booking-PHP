  ...
  //error handling:
    ...
    <div class="signup-form">
		...
		<option>20:00 - 00:00</option>
        	...
        	<input type="number" class="form-control" min="1" name="num_guests" placeholder="students" required="required">
            ...
            <div class="form-group">
            <label>Enter extra Requirnments</label>
                <textarea class="form-control" name="comments" placeholder="Pc, Projectors,Tables, Books....ETC" rows="3"></textarea>
		...
		<label class="checkbox-inline"><input type="checkbox" required="required"> I accept the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
            ...
            <div class="form-group">
            <button type="submit" name="reserv-submit" class="btn btn-dark btn-lg btn-block">Book cabin</button>
            </div>
        </form>
        <br><br>
    </div>
