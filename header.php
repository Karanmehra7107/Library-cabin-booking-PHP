...
<title>Study cabin booking</title>
<meta charset="utf-8">
...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong>Library Study Cabin</strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="reservation.php" >New cabin booking</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_reservations.php" >View booked cabin</a>
                    </li>';
